...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th5 08, 2021 lúc 12:57 AM
...
(1, 'admin@gmail.com', 'c4ca4238a0b923820dcc509a6f75849b', 'Phạm Duy Nhuận');
...
--
-- Cấu trúc bảng cho bảng `tbl_dulich`
--

CREATE TABLE `tbl_dulich` (
  `dulich_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  `dulich_name` varchar(255) NOT NULL,
  `dulich_chitiet` text NOT NULL,
  `dulich_mota` text NOT NULL,
  `dulich_image` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Đang đổ dữ liệu cho bảng `tbl_dulich`
--

INSERT INTO `tbl_dulich` (`dulich_id`, `category_id`, `dulich_name`, `dulich_chitiet`, `dulich_mota`, `dulich_image`) VALUES
(49, 8, 'Du lịch Sapa', ' dasda', ' ádsa', '5.jpg'),
(50, 8, 'Du lịch Sapa', ' sad', ' áda', '2.jpg');
...
(67, 'Phạm Duy Nhuận', '0843346399', 'Vĩnh Long', 'sda', '18004095@student.vlute.edu.vn', 'c4ca4238a0b923820dcc509a6f75849b', 1);
...
--
-- Chỉ mục cho bảng `tbl_dulich`
--
ALTER TABLE `tbl_dulich`
  ADD PRIMARY KEY (`dulich_id`);
...
--
-- AUTO_INCREMENT cho bảng `tbl_dulich`
--
ALTER TABLE `tbl_dulich`
  MODIFY `dulich_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
